...
function run()
{
    ...
    result=result_syn/${1:9}_${algo}
    resultML=result_syn/${1:9}_${algo}_ML
    data_algo=${1:9}_${algo}
#    echo ${algo}

    ./bin/FlowSizeSYN $dataset $result $type 0 ${data_algo}
    ...
    ./bin/FlowSizeSYN $dataset $resultML $type 1 ${data_algo}
